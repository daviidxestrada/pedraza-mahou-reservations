...
final class PMR_Emails
{
    ...
    private static function customer_email_body(array $reservation): string
    {
        ...
        return '<p style="margin:0 0 12px;color:#263340;font-size:16px;line-height:1.7;">'
            ...
            . '<h2 class="pmr-email-heading" style="margin:26px 0 12px;color:#002c3e;font-family:League Spartan,Arial,Helvetica,sans-serif;font-size:19px;line-height:1.3;">'
    ...
    private static function wrap_email(string $eyebrow, string $title, string $body, array $reservation): string
    {
        ...
        return '<!doctype html><html lang="es"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1">'
            . '<style>@import url("https://fonts.googleapis.com/css2?family=League+Spartan:wght@600;700;800&family=Montserrat:wght@400;500;600;700&display=swap");.pmr-email-body,.pmr-email-content,.pmr-email-footer{font-family:"Montserrat",Arial,Helvetica,sans-serif!important}.pmr-email-heading{font-family:"League Spartan",Arial,Helvetica,sans-serif!important}@media only screen and (max-width:560px){.pmr-email-shell{padding:12px!important}.pmr-email-header,.pmr-email-content,.pmr-email-footer{padding-left:18px!important;padding-right:18px!important}.pmr-email-summary-cell{display:block!important;width:auto!important;margin-bottom:8px!important}.pmr-email-detail-label,.pmr-email-detail-value{display:block!important;width:auto!important}.pmr-email-detail-label{border-bottom:0!important;padding-bottom:3px!important}.pmr-email-detail-value{padding-top:3px!important}}</style>'
            . '</head><body class="pmr-email-body" style="margin:0;padding:0;background:#f4f7f8;font-family:Montserrat,Arial,Helvetica,sans-serif;color:#263340;">'
            ...
            . '<table role="presentation" cellspacing="0" cellpadding="0" style="width:100%;border-collapse:collapse;background:#f4f7f8;"><tr><td class="pmr-email-shell" align="center" style="padding:32px 12px;">'
            . '<table role="presentation" cellspacing="0" cellpadding="0" style="max-width:680px;width:100%;overflow:hidden;border:1px solid #e0e7ea;border-radius:8px;background:#ffffff;box-shadow:0 12px 34px rgba(0,44,62,.09);">'
            ...
            . '<table role="presentation" cellspacing="0" cellpadding="0" style="width:100%;border-collapse:collapse;"><tr>'
            . '<td valign="middle"><h1 class="pmr-email-heading" style="margin:0;color:#ffffff;font-family:League Spartan,Arial,Helvetica,sans-serif;font-size:27px;line-height:1.2;">' . esc_html($title) . '</h1></td>'
            ...
            . '</tr></table></td></tr>'
            . '<tr><td class="pmr-email-content" style="padding:28px 30px 30px;font-size:15px;line-height:1.6;">' . $body . '</td></tr>'
            . '<tr><td class="pmr-email-footer" style="padding:20px 30px;border-top:1px solid #e5eaed;background:#f3f8f9;color:#63727b;font-size:11px;line-height:1.7;">'
